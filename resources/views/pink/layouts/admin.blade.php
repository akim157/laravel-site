...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset(config('settings.theme')) }}/css/cache-custom.css" /> <!-- MAIN THEME STYLESHEET -->
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset(config('settings.theme')) }}/css/jquery-ui-1.9.2.custom.min.css" /> <!-- MAIN THEME STYLESHEET -->
    ...
    <script type="text/javascript" src="{{ asset(config('settings.theme')) }}/js/jquery-ui-1.9.2.custom.min.js"></script>
